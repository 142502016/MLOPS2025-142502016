...
def hyperparameter_tuning():
    ...
    with mlflow.start_run(nested=True,run_name="Hyperparameter Tuning Session") as parent_run:
        best_accuracy = 0
        best_model = None
        best_run_id = None
    ...
    for params in rf_params:
        with mlflow.start_run(nested=True,run_name=f"RF_estimators_{params['n_estimators']}depth{params['max_depth']}"):
